...
public enum SocketTransport {
    ...
    public static func read(_ fd: Int32) throws -> Data {
        ...
        while data.count <= maxBytes {
            ...
            guard count > 0 else { throw ServiceFailure("The blocking service did not respond. Open the Muzzle window and choose Set Up Blocking Service.") }
    ...
    public static func request(_ command: ServiceCommand) throws -> ServiceResponse {
        ...
        guard connected == 0 else { throw ServiceFailure("Open the Muzzle window and choose Set Up Blocking Service. Protection cannot be changed until it is available.") }
